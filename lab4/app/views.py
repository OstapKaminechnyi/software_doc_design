...
def post():
    ...
    if 'url' in form_values:
        url = form_values['url']
        rows_per_time = int(form_values['rows_per_time']) if 'rows_per_time' in form_values else 100
        rows_number = int(form_values['rows_number']) if 'rows_number' in form_values else 200
        offset = int(form_values['offset']) if 'offset' in form_values else 0
